...
public class ButtonsTest extends TestCase
{
	...
	public void testCheckNextButton() throws Exception
	{
		...
		nextURL = "index.jsp?report=totals&graph=cumul&start=150000&end=300000&resultLimit=15&view=LOCAL_IP";
		...
		nextURL = "index.jsp?report=totals&graph=cumul&start=225000&end=375000&resultLimit=15&view=LOCAL_IP";
	...
	public void testCheckPrevButton() throws Exception
	{
		...
		prevURL = "index.jsp?report=totals&graph=cumul&start=0&end=300000&resultLimit=15&view=LOCAL_IP";
		...
		prevURL = "index.jsp?report=totals&graph=cumul&start=-150000&end=150000&resultLimit=15&view=LOCAL_IP";
	...
	public void testCheckZoomOutButton() throws Exception
	{
		...
		zoomURL = "index.jsp?report=totals&graph=cumul&start=-150000&end=450000&resultLimit=15&view=LOCAL_IP";
		...
		zoomURL = "index.jsp?report=totals&graph=cumul&start=-450000&end=750000&resultLimit=15&view=LOCAL_IP";
	...
	public void testCheckZoomInButton() throws Exception
	{
		...
		zoomURL = "index.jsp?report=totals&graph=cumul&start=0&end=300000&resultLimit=15&view=LOCAL_IP";
