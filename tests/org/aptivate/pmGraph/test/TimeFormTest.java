...
public class TimeFormTest extends TestCase
{
	...
	{
		// Message removing the escape characters because it's autogenerated a
		// javascript message
		...
		for (int i = 0; i < noElements; i++)
		{
			...
			assertEquals("Check to date format alert.", dateTimeError, wc
					.popNextAlert());
		}
		// Restore to valid
		response.getElementWithID("toDate").setAttribute("value", "03/03/2009");
		...
		for (int i = 0; i < noElements; i++)
		{
			...
			assertEquals("Check from date format alert.", dateTimeError, wc
					.popNextAlert());
		}
		// Restore to valid
		response.getElementWithID("fromDate").setAttribute("value",
		...
		for (int i = 0; i < noElements; i++)
		{
			...
			assertEquals("Check to time format alert.", dateTimeError, wc
					.popNextAlert());
		}
		// Restore to valid
		response.getElementWithID("toTime").setAttribute("value", "15:54:32");
		...
		for (int i = 0; i < noElements; i++)
		{
			...
			assertEquals("Check from time format alert.", dateTimeError, wc
					.popNextAlert());
		}
		...
		subButton.click();
		assertEquals("Date in future.", ErrorMessages.TIME_IN_FUTURE, wc
				.popNextAlert());
		...
		subButton.click();
		assertEquals("Time in future.", ErrorMessages.TIME_IN_FUTURE, wc
				.popNextAlert());
		...
		response.getElementWithID("fromTime").setAttribute("value",
				timeFormat.print(currentTime));
		subButton.click();
		assertEquals("From equals To.", ErrorMessages.TIME_NOT_ENOUGH, wc
				.popNextAlert());
